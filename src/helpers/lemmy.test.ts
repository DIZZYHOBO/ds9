...
describe("keywordFoundInSentence", () => {
  ...
  it("false with keyword in sentence", () => {
    expect(keywordFoundInSentence("keyword", "Hello, this is Tuvix!")).toBe(
      false,
    );
  });

  it("true with keyword in middle", () => {
    expect(keywordFoundInSentence("this", "Hello, this is Tuvix!")).toBe(
      true,
    );
  });

  it("false with partial keyword in middle", () => {
    expect(keywordFoundInSentence("thi", "Hello, this is Tuvix!")).toBe(
      false,
    );
  });

  it("true with multi word keyword", () => {
    expect(keywordFoundInSentence("this is", "Hello, this is Tuvix!")).toBe(
      true,
    );
  });

  it("true with keyword without comma", () => {
    expect(keywordFoundInSentence("Hello", "Hello, this is Tuvix!")).toBe(
      true,
    );
  });
  ...
  it("true with multi keyword with comma", () => {
    expect(
      keywordFoundInSentence("Hello, this", "Hello, this is Tuvix!"),
    ).toBe(true);
  });
  ...
  it("true case insensitive", () => {
    expect(keywordFoundInSentence("voyageR", "Hello, this is Tuvix!")).toBe(
      true,
    );
  });
});
