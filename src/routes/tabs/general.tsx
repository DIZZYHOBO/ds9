...
import MastodonCommunityPage from "#/features/mastodon/pages/MastodonCommunityPage";
...
export default [
  ...
  <Route exact path="/:tab/mastodon/lemmy/:instance/c/:community">
    <MastodonCommunityPage />
  </Route>,
  // Lemmy routes
